          ...
          <Tabs defaultActiveKey="Original" id="uncontrolled-tab-example">
            <Tab eventKey="Original" title="Original">
              <GridDiv className="grid-container">
                ...
                <FileUploadComponent isUploaded={(value: boolean) => setProcessed(value)}/>
                </div>
                <div className="grid-item">
            ...
            <Tab eventKey="RemoveBG" title="Remove BG" disabled={processed}>
            ...
            <Tab eventKey="Add-Background" title="Add Background" disabled={processed}>
